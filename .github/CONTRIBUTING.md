...
We do not use github issues for general library support. We think this questions should be posted on stack overflow using [Kandinsky](http://http://stackoverflow.com/questions/tagged/Kandinsky) tag.

### Reporting issues

* Use [github issues](https://github.com/mislavjavor/Kandinsky/issues) to report a bug.
* Before creating a new issue:
  * Make sure you are using the [latest release](https://github.com/mislavjavor/Kandinsky/releases).
  * Check if the issue was [already reported or fixed](https://github.com/mislavjavor/Kandinsky/issues?utf8=%E2%9C%93&q=is%3Aissue). Notice that it may not be released yet.
...
1. Fork the Kandinsky repository.
2. Clone your forked project into your developer machine: `git clone git@github.com:<your-github-username>/Kandinsky.git`
3. Add the original project repo as upstream repository in your forked project: `git remote add upstream git@github.com:mislavjavor/Kandinsky.git`
...
* We use `type: feature request` label to mark all [feature request issues](https://github.com/mislavjavor/Kandinsky/labels/type%3A%20feature%20request).
